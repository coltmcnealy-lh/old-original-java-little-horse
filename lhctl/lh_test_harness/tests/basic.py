...
def basic_launch_1(client: TestClient, wf_spec_id: str):
    wf_run_id = client.run_wf(wf_spec_id)
    logging.info(f"Launched test {wf_run_id} on basic.py.")
...
def basic_check_1(wf_run: WFRunSchema):
