...
import io.littlehorse.common.objects.metadata.EdgeCondition;
import io.littlehorse.common.objects.metadata.ExceptionHandlerSpec;
import io.littlehorse.common.objects.metadata.InterruptDef;
...
public class ThreadRun extends BaseSchema {
    ...
    private boolean activateTaskNode(
        ...
        tsr.kafkaTopic = config.getWFRunEventTopic();
        try {
